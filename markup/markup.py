...
class Keyboards:
    ...
    def remove_menu():
        """
        Удаляет данные кнопки и возвращает пустую клавиатуру
        """
        return ReplyKeyboardRemove()

    def category_menu(self):
        """
        Создаёт разметку кнопок в меню категорий товара и возвращает разметку
        """
    ...
    def set_inline_btn(name):
        """
        Создаёт и возвращает инлайн кнопку по входным параметрам
        """
    ...
    def set_select_category(self, category):
        """
        Создаёт разметку инлайн кнопок в выбранной категории товара и возвращает разметку
        """
    ...
    def orders_menu(self, step, quantity):
        """
        Создаёт разметку кнопок в заказе товара и возращает разметку
        """
        self.markup = ReplyKeyboardMarkup(True, True)
